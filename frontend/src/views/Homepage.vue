<template>
  <!-- <div class="container">
    ...
    <div class="info-container">
      <div class="details">
        Öppettider, address och telefonnr
      </div>
      <div class="cinema-info">
        Info om biografen. Salonger och antal platser
      </div>
    </div>
...
import Nav from '../components/homepagecomp/Nav'
import TopMovies from '../components/homepagecomp/TopMovies'
import Calendar from '../components/homepagecomp/Calendar'


export default {
  components: { Movies, Info, Nav, TopMovies, Calendar }
...
<style scoped>
  ...
  /* .container {
    ...
    grid-auto-rows: 70px 200px 500px 500px 300px;
  }
